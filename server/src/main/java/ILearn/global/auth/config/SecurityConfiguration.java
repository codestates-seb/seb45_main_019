...
//                                .antMatchers(HttpMethod.GET, "/*/members").hasRole("ADMIN")
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://i-learn.s3-website.ap-northeast-2.amazonaws.com", "http://ec2-13-209-48-235.ap-northeast-2.compute.amazonaws.com:8080", "http://i-learn.site", "http://localhost:8080", "http://localhost:3000"));
