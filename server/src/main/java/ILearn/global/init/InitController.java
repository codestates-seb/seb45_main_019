...
public class InitController {
    ...
    public void InitGenerator() {
        ...
        for (Chapter chapter : chapterList) {
            ...
            if (existingChapterIds.contains(20L)) {
                ApiResponse<?> errorResponse = new ApiResponse<>(false, "Chapter exists.");
                throw new ApiResponseException(errorResponse, null);
            }
        ...
        for (Word word : wordList) {
            if (existingWordIds.contains(60L)) {
                ApiResponse<?> errorResponse = new ApiResponse<>(false, "Word exists.");
                throw new ApiResponseException(errorResponse, null);
            }
            wordRepository.save(word);
            existingWordIds.add(word.getWordId());
        }
        ...
        for (Long wordId = 1L; wordId <= 60L; wordId++) {
            ...
            for (Question question : generatedQuestions) {
                ...
                if (existingQuestionIds.contains(240L)) {
                    ApiResponse<?> errorResponse = new ApiResponse<>(false, "Question exists.");
                    throw new ApiResponseException(errorResponse, null);
                }
